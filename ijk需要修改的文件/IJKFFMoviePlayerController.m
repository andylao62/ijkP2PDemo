...
static const char *kIJKFFRequiredFFmpegVersion = "ff4.0--ijk0.8.25--20200221--001";
...
//by alex
@property(nonatomic) NSMutableData *mulFrameData;
@end
                   ...
                   withOptions:(IJKFFOptions *)options
{
    ...
    self = [super init];
    if (self) {
        self.mulFrameData = [NSMutableData new];
        ijkmp_global_init();
...
//    ijkmp_set_option(_mediaPlayer, IJKMP_OPT_CATEGORY_PLAYER, "an", "1");
